...
root =tk.Tk()
root.title("Image Encryption Using DNA")
root.configure(background="black")
cwgt=tk.Canvas(root)
cwgt.pack(expand=True, fill=tk.BOTH)
image1=ImageTk.PhotoImage(file="47.jpg")
root.geometry('800x550')
cwgt.img=image1
cwgt.create_image(-300, -500, anchor=tk.NW, image=image1)
...
class MyButton:
	def __init__(self, root):
		...
		self.f.propagate(0)
		self.f.pack()
		b1=tk.Button(root,text="Encrypt & Decrypt",bg="white",fg="black", cursor='watch',command=self.main).place(x=315,y=55, width=170,height=30)
		#b2=tk.Button(root,text="recieve",bg="lightblue",fg="black", cursor='watch').place(x=450,y=10, width=100, height=30)
		b4= tk.Button(root, text="Exit", bg="white", fg="BLACK",cursor='watch',command=exit).place(x=350,y=370, width=100, height=30)
	...
	def main(self):
		...
		def dna_encode(b,g,r):
			print("Encryption to Decryption")
		...
		def recover_image(b,g,r,iname):
			...
			print("Encrypted image will be saved as Encrypted.jpg")
			return img
